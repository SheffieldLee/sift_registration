...
def image_fusion(image1, image2, solution):
    ...
    cv2.imshow("image1-perspective", image1_perspective) # 利用透视,图像周围填充0.5倍边长的黑边
    cv2.imwrite('./savedata/image1-perspective.jpg', image1_perspective)
    ...
    cv2.imwrite('./savedata/image1-transform.jpg', image1_transform)
