...
threshold = 300
# read image
img1 = cv2.imread("testdata/i1.jpg") # image to be registered
img2 = cv2.imread("testdata/i2.jpg") # reference image
...
good_kp1, good_kp2 = match.match(kp1_location, kp2_location, des1, des2, sift_ratio)  # SIFT特征点匹配，经过ratio = 0.7的筛选
img_good = display.display(img1, img2, good_kp1, good_kp2)  # 标点连线
cv2.imwrite('./savedata/img_good.jpg', img_good)  # 保存sift配准后的图片
...
img_better = display.display(img1, img2, better_kp1, better_kp2)  # 标点连线
cv2.imwrite('./savedata/img_better.jpg', img_better)
